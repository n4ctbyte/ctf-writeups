...
![360 Map](img/yellow-lines-front-image.png)

![360 Map](img/yellow-lines-back-image.png)

### Step 2: Finding the Location

First, let's do a full reverse image search using Google Lens.

![Google Lens Result](img/yellow-lines-lens.png)
...
![Google Lens Similar Result](img/yellow-lines-b1.png)
...
![The Exact Location](img/yellow-lines-exact-location.png)
